...
export type ContentModule = TextContentModule | FieldContentModule
...
export type TextObject = PlainTextObject | LarkMdObject
...
export type OptionObject = BaseOptionObject | OverflowOptionObject
