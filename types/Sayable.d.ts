 ...
 * 文本消息参数
 */
export declare type TextMessageParams = {
    content: string;
} & ReceiverParams;
/**
 * 图片消息
 */
export declare type ImageMessageParams = {
    imageKey: string;
} & ReceiverParams;
/**
 * 富文本消息
 */
export declare type RichTextMessageParams = {
    post: RichTextMessage;
} & ReceiverParams;
/**
 * 分享群名片
 */
export declare type ShareChatCardParams = {
    shareChatId: string;
    userId: string;
};
export declare type CardMessageParams = {
    card: CardMessage;
